...
function registrarProducto($codigo, $nombre, $compra, $venta, $existencia,$idcategoria){
    $sentencia = "INSERT INTO productos(codigo, nombre, compra, venta, existencia,Idcategoria) VALUES (?,?,?,?,?,?)";
    $parametros = [$codigo, $nombre, $compra, $venta, $existencia,$idcategoria];
    return insertar($sentencia, $parametros);
}
